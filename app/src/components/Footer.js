      ...
      <Container>
        <Row>
          ...
          <Col md={4}>
            ...
            <hr />
            <Nav className="flex-column text-center">
              <Nav.Link as={Link} to="/imprint" className="text-white-50">Impressum</Nav.Link>
              <Nav.Link as={Link} to="/policys" className="text-white-50">Datenschutz</Nav.Link>
              <Nav.Link as={Link} to="forumguidelines" className="text-white-50">Forum-Richtlinien</Nav.Link>
            </Nav>
          </Col>
        </Row>
        <Row className="mt-5">
          ...
          <Col className="text-center text-white-50 mt-3">
            <p>&copy; {currentYear} Veranstaltungskalender für Ford Fiesta. Alle Rechte vorbehalten.</p>
          </Col>
        </Row>
      </Container>
    </footer>
